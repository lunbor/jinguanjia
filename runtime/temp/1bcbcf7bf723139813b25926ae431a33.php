<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"F:\wamp\www\guanjia\public/../application/admin\view\agent\agent.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\header.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\footer.html";i:1548489490;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-12">   
					<div  class="col-sm-2" style="width: 100px">
						<div class="input-group" >  
							<a href="<?php echo url('add_agent'); ?>"><button class="btn btn-outline btn-primary" type="button">添加代理商</button></a> 
						</div>
					</div>                                    
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('agent'); ?>">
						<div class="col-sm-2">
                            <div class="input-group">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td><?php echo $vo['prev_agent']; ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></td>
                                <td><?php echo $status[$vo['status']]; ?></td>
                                <td>
                                    <a href="javascript:;" onClick="edit_agent(<?php echo $vo['id']; ?>)" class="btn btn-primary btn-xs btn-outline">编辑</a>&nbsp;&nbsp;
									 <a href="javascript:;" onClick="agent_account(<?php echo $vo['id']; ?>)" class="btn btn-primary btn-xs btn-outline">资金明细</a>&nbsp;&nbsp;
									 <a href="javascript:;" onClick="agent_member(<?php echo $vo['id']; ?>)" class="btn btn-primary btn-xs btn-outline">推广会员</a>&nbsp;&nbsp;
                                </td>
                            </tr>
