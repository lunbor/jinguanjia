<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\wamp\www\guanjia\public/../application/admin\view\menu\index.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\header.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\footer.html";i:1548489490;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="example-wrap">
                <div class="example">
                    <form id="ruleorder" name="ruleorder" method="post" action="<?php echo url('ruleOrderBy'); ?>" >
                            ...
                            <tbody>
                                <?php if(is_array($admin_rule) || $admin_rule instanceof \think\Collection || $admin_rule instanceof \think\Paginator): if( count($admin_rule)==0 ) : echo "" ;else: foreach($admin_rule as $key=>$v): ?>
                                    <tr class="long-td">
                                        ...
                                        <td>
                                            <?php if($v['status'] == 1): ?>
                                                <a class="red" href="javascript:;" onClick="state(<?php echo $v['id']; ?>);">
                                        ...
                                        <td>
                                            <a href="<?php echo url('edit',['id'=>$v['id']]); ?>" class="btn btn-primary btn-outline btn-xs">
    ...
    <div class="modal  fade" id="myModal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" name="add_rule" id="add_rule" method="post" action="<?php echo url('add'); ?>">
                    <div class="ibox-content">
