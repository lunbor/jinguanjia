<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\wamp\www\guanjia\public/../application/admin\view\role\index.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\header.html";i:1548489490;s:61:"F:\wamp\www\guanjia\application\admin\view\public\footer.html";i:1548489490;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Role/index"); ?>', {page: curr || 1,key:key}, function(data){
    ...
    //删除角色
    function del(id){
        lunhui.confirm(id,'<?php echo url('del'); ?>');
    }
